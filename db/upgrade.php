...
function xmldb_videoboard_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2014030200) {
        ...
        $table = new xmldb_table('videoboard_likes');
        ...
        upgrade_mod_savepoint(true, 2014030200, 'videoboard');
    }
    
    
    if ($oldversion < 2014080400) {
        // Define table assign_user_mapping to be created.
        $table = new xmldb_table('videoboard');
        ...
        // Assign savepoint reached.
        upgrade_mod_savepoint(true, 2014080400, 'videoboard');
    }
